...
# Author:  ALAN 007.
# Facebook: NAYIMUR RAHMAN DURJOY
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│     \033[92m ╔═╗╦  ╔═╗╔╗╔   ╔╗ ╔═╗╔╦╗╔╗ ╔═╗╦═╗\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m ╠═╣║  ╠═╣║║║───╠╩╗║ ║║║║╠╩╗║╣ ╠╦╝  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m ╩ ╩╩═╝╩ ╩╝╚╝   ╚═╝╚═╝╩ ╩╚═╝╚═╝╩╚═  007 \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : ALAN 007.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mFacebook : NAYIMUR RAHMAN DURJOY \033[94m│".center(columns+9))
    print("│ \033[95mOwner  : Alan 007              \033[37mV1.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def banner():
    ...
    print("\033[92mProcess : \033[37mALAN-BOMB Started               ".center(columns + 10))
...
def check(sent):
    ...
    print(f"\r\033[92m    [\033[94m {current_time} \033[92m] ALAN-BOMB Sent : \033[94m[\033[37m{sent}\033[94m]\033[37m", end="")
    
    if (sent == amount):
        psb("\n\n\033[92m    [\033[37m*\033[92m] ALAN Bombing Finished!😴")
        psb("\033[92m    [\033[37m*\033[92m] Amount : \033[37m" + str(amount))
        psb("\033[92m    [\033[37m*\033[92m] Target : \033[37m0" + main.number)
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mALAN-BOMB\n")
        time.sleep(0.6)
        print("\033[92m[\033[93m★\033[92m] Thanks For Using ALAN-BOMB \033[92m[\033[93m★\033[92m]".center(columns + 30))
        print("\033[37m")
